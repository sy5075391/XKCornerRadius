...
@interface XKDeviceDataLibrery()

@property (nonatomic, assign) DiviceType iDevice;

@end

@implementation XKDeviceDataLibrery

#pragma mark - Public Method

+(instancetype)sharedLibrery {
    static XKDeviceDataLibrery *_librery;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _librery = [[XKDeviceDataLibrery alloc] init];
